...
const AUTHORS = [
  ...
  { name: "Эрик Берн", note: "«Игры, в которые играют люди» и «Люди, которые играют в игры» — транзактный анализ: состояния Я (Родитель–Взрослый–Ребёнок), роли и сценарии. Тема психологических игр зацепила настолько, что легла в основу моих обучающих игр-новелл." },
  { name: "Михаил Гребенюк", note: "Книги не читал — проходил его тренинги по выбору ниши и не только. Прикладно и по делу про продажи и упаковку дела." },
];
